...
#define FUEL_CHANNELS_7_12    16,17,8,9,27,29
...
#define SPARK_CHANNELS_7_12   25,25,25,25,25,25   /* not used for 5634*/ 
#define TACH_CHANNEL          22                  // Tach Output (pwm) eTPU chan
#define FUEL_PUMP_PIN         179                 // fuel pump
#define WHEEL_SPEED_1_4       18, 19, 20, 21      // read wheel speed
...
#define PWM1_CHANNEL 24     // eTPU channel to use for servo motor output 
