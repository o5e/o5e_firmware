...
/*****************************************************************************************/
    ...
    // Note: AN12-AN15 have pad numbers and use B0011 to make them AN pins
        ...
        SIU.PCR[122].R = GPIO | UNUSED; 	// eTPU[8] pin available, etpu 8 reserved for injector 9
        SIU.PCR[123].R = GPIO | UNUSED; 	// eTPU[9] pin available, etpu 9 reserved forinjector 10
        ...
        SIU.PCR[138].R = GPIO | UNUSED; 	// eTPU[24]  injector 11
        SIU.PCR[139].R = GPIO | UNUSED; 	// eTPU[25]  injector 12
