...
/*****************************************************************************************/
    ...
    // Note: AN12-AN15 have pad numbers and use B0011 to make them AN pins
        ...
        SIU.PCR[187].R = B0010 | OUTPUT;        // eMIOS 8 (B0001) or injector 9 eTPU[8] (B0010) 
        SIU.PCR[188].R = B0010 | OUTPUT;        // eMIOS 9 (B0001) or injector 10 eTPU[9] (B0010)    
        SIU.PCR[189].R = GPIO | OUTPUT; 	// flashing LED or eMIOS (10)  
        SIU.PCR[190].R = GPIO | OUTPUT; 	// flashing LED or eMIOS (11)  
        SIU.PCR[191].R = B0100 | OUTPUT;    // eMIOS 12 (B0001) or injector 11 eTPU[27](B0100)

        SIU.PCR[192].R = B0001 | OUTPUT; 	// eMIOS 13 (B0001) or GPIO 
        SIU.PCR[193].R = B0100 | OUTPUT;    // eMIOS 14 (B0001) or injector 12 eTPU[29](B0100)
