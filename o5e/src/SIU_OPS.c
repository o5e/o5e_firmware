...
/*****************************************************************************************/
    ...
    // Note: AN12-AN15 have pad numbers and use B0011 to make them AN pins
        ...
        SIU.PCR[122].R = GPIO  | OUTPUT; 	// eTPU[8] ignition 4
        ...
        SIU.PCR[128].R = B0001 | INPUT; 	// eTPU[14] wheelspeed FLinjector 7
        SIU.PCR[129].R = B0001 | INPUT; 	// eTPU[15] wheelspeed FRpin available 
        SIU.PCR[130].R = B0001 | INPUT;     // eTPU[16] wheelspeed RLinjector 8
        SIU.PCR[131].R = B0001 | INPUT;     // eTPU[17] wheelspeed RR
        SIU.PCR[132].R = B0001 | INPUT;    // eTPU[18]  
        SIU.PCR[133].R = B0001 | INPUT;    // eTPU[19] 
        SIU.PCR[134].R = B0001 | INPUT;    // eTPU[20] 
        SIU.PCR[135].R = GPIO  | UNUSED; 	// eTPU[21] pin available
