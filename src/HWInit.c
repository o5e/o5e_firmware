...
/*
 *
 * FILE : MPC5634M_MLQC80_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5634M_MLQC80 derivative needed initializations, 
 *  and all initializations for the MPC5634M_MLQC80 boards which are supported.
 *  This includes setting up the External Bus Interface to allow access
 *  to memory on the external bus, and ensuring there is a valid entry in
 *  the MMU for the external memory access.
 */
...
#include "MPC5634M_MLQC80.h"       /* MPC55xx platform development header            */
#include "MPC5634M_MLQC80_HWInit.h"
...
/*******************************************************/
/* MPC5634M_MLQC80 derivative specific hardware initialization */
/*******************************************************/

/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC5634M_MLQC80. 
*/
/*lint -esym(752, L2SRAM_LOCATION) */
extern long L2SRAM_LOCATION;  
...
nofralloc
    ...
    /* MPC5634M_MLQC80 L2SRAM initialization code                         */
    lis r11,L2SRAM_LOCATION@h /* Base address of the L2SRAM, 64-bit word aligned */
    ori r11,r11,L2SRAM_LOCATION@l
...
/*******************************************************/
/* MPC5634M_MLQC80 boards specific hardware initializations    */
/*******************************************************/
